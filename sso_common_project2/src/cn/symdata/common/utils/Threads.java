 ...
 *@Since:2015年2月3日  上午10:14:33
 *@Version:1.0
 */
public class Threads {
	
	private  static final int shutdownTimeout = Integer.MAX_VALUE;
	...
	public static ThreadPoolExecutor getThreadPool() {
		if (threadPool == null) {
//			logger.info("threadPool is init...");
			threadPool = new ThreadPoolExecutor(10, shutdownTimeout, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>());  
//			threadPool = Executors.new;//new ThreadPoolExecutor(10, 30, 3, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(3), new ThreadPoolExecutor.CallerRunsPolicy());
		}
		return threadPool;
	}
	/**
