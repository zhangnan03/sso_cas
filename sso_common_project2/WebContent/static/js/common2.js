...
var messages = {
	...
	"admin.dialog.marketableConfirm": "您确定要上架吗？",
	"admin.dialog.notMarketableConfirm": "您确定要下架吗？",
	...
	"admin.dialog.outStockConfirm": "您确定要处理吗？"
};
	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
					...
					isUpload: true,
					browserUrl: emall.base + "/admin/file/browser.jhtml",
					uploadUrl: emall.base + "/admin/file/upload.jhtml",
					callback: null
				};
				$.extend(settings, options);
