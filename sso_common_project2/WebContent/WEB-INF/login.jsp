...
<%} else {%>
<title>提示信息 - Powered By symdata</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<link href="<%=base%>/static/css/common.css" rel="stylesheet" type="text/css" />
			...
			<input type="hidden" name="captchaId" value="<%=captchaId%>" />
				<table>
					...
					<tr>
							...
							<td>
								<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="<%=base%>/common/captcha.jhtml?captchaId=<%=captchaId%>" title="<%=SpringUtils.getMessage("admin.captcha.imageTitle")%>" />
							</td>
						</tr>
					<tr>
						<td>
