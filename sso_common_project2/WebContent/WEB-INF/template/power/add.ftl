  		...
  		<input type="hidden" id="menuId" name="menu.id" /> 
			<tbody>
				<tr>
					...
					<td class="p-col2">
						<input type="text" name="name" class="text" maxlength="200"maxlength="200"/>
					</td>
				</tr>
				<div id="passInfo">
				<tr>
				...
				<tr>
				   ...
				   <td class="p-col2"> 
		              <div>
		                ...
		                <input type="text" id="menuName" name="menuName" class="text" readonly onclick="focusMenu()" placeholder="请选择菜单">
		              </div>
				   </td>
				</tr>
				<tr>
