...
(function(a) {
	...
	a.extend(a.validator, {
		...
		messages: {
			...
			equalTo: "请再次输入.",
			maxlength: a.validator.format("请输入不超过 {0} 的字符."),
			minlength: a.validator.format("请输入至少 {0} 位字符."),
			rangelength: a.validator.format("{0} 和 {1} 之间."),
			range: a.validator.format("{0} 和 {1} 之间."),
